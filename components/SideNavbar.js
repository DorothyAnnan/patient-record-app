      ...
      <Disclosure as="nav">
        ...
        <div className="p-6 w-1/2 h-screen bg-white z-20 fixed top-0 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
          <div className="flex flex-col justify-start item-center">
            <h1 className="text-base text-center cursor-pointer font-bold text-gray-700 border-b border-gray-100 pb-4 w-full">
              <span className="text-cyan-500">Patient</span> Record
            </h1>
          </div>
          <div className="flex justify-center mt-4">
            <a href="#" className="mt-3">
              <FaNotesMedical className="text-7xl text-gray-600" />
            </a>
          </div>
          <div className=" my-4 border-b border-gray-100 pb-4">
            ...
            <Link href="/dashboard/patients/search-patient">
              <div className="flex  mb-2 justify-start items-center gap-4 pl-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto">
                <FaHospitalUser className="text-2xl text-gray-600 group-hover:text-white " />
                <h3 className="text-base text-gray-800 group-hover:text-white font-semibold ">
                  Search Patient
                </h3>
              </div>
            ...
            <div className="flex  mb-2 justify-start items-center gap-4 pl-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto">
              <MdContacts className="text-2xl text-gray-600 group-hover:text-white " />
              <h3 className="text-base text-gray-800 group-hover:text-white font-semibold ">
                Contacts
              </h3>
            </div>
            ...
            <Link href="/">
              <div className=" my-12 pt-16 border-b border-gray-100 pb-">
                <div className="flex mb-2 justify-start items-center gap-4 pl-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto">
                ...
                {/* <DropDown  className="text-2xl text-gray-600 group-hover:text-white "></DropDown> */}
              </div>
            </Link>
          </div>
        </div>
